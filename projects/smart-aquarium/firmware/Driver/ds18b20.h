...
#define DS18B20_IO_IN()  {DS18B20_GPIO_PORT->CRL&=0xFFFFFFF0;DS18B20_GPIO_PORT->CRL|=0x00000008;}
#define DS18B20_IO_OUT() {DS18B20_GPIO_PORT->CRL&=0xFFFFFFF0;DS18B20_GPIO_PORT->CRL|=0x00000003;}
