...
import com.example.project.entity.Timetable;
...
public class TimetableController {
    ...
    public Result deleteBatch(@RequestBody List<Integer> ids) {
        timetableService.removeByIds(ids);
        return Result.success();
    }
    ...
    public Result findPage(@RequestParam(defaultValue = "") String name,
        ...
        QueryWrapper<Timetable> queryWrapper = new QueryWrapper<Timetable>().orderByDesc("id");
        ...
        return Result.success(timetableService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Timetable信息表", "UTF-8");
    ...
    */
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Timetable> list = reader.readAll(Timetable.class);

        timetableService.saveBatch(list);
        return Result.success();
    }
