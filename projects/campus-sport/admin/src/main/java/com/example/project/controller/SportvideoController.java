...
public class SportvideoController {
    ...
    @AutoLog("新增运动教学视频")
    @PostMapping
    public Result save(@RequestBody Sportvideo sportvideo) {
	

		
        sportvideoService.save(sportvideo);
        return Result.success();
    }

    @AutoLog("编辑运动教学视频")
    @PutMapping
    public Result update(@RequestBody Sportvideo sportvideo) {
        sportvideoService.updateById(sportvideo);
    ...
    public Result delete(@PathVariable Integer id) {
        sportvideoService.removeById(id);
        return Result.success();
    }
    ...
    public Result deleteBatch(@RequestBody List<Integer> ids) {
        sportvideoService.removeByIds(ids);
        return Result.success();
    }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        // 从数据库查询出所有的数据
        List<Sportvideo> list = sportvideoService.list();
        // 在内存操作，写出到浏览器
        ...
        String fileName = URLEncoder.encode("Sportvideo信息表", "UTF-8");
    ...
    */
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Sportvideo> list = reader.readAll(Sportvideo.class);

        sportvideoService.saveBatch(list);
        return Result.success();
    }
