...
public class TimeslotController {
    ...
    @AutoLog("新增场地时间安排表")
    @PostMapping
    public Result save(@RequestBody Timeslot timeslot) {
    ...
    public Result deleteBatch(@RequestBody List<Integer> ids) {
        timeslotService.removeByIds(ids);
        return Result.success();
    }
    ...
    public Result findPage(@RequestParam(defaultValue = "") String name,
        ...
        QueryWrapper<Timeslot> queryWrapper = new QueryWrapper<Timeslot>().orderByDesc("id");
        ...
        return Result.success(timeslotService.page(new Page<>(pageNum, pageSize), queryWrapper));
    }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        // 从数据库查询出所有的数据
        List<Timeslot> list = timeslotService.list();
        // 在内存操作，写出到浏览器
        ...
        String fileName = URLEncoder.encode("Timeslot信息表", "UTF-8");
    ...
    */
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Timeslot> list = reader.readAll(Timeslot.class);

        timeslotService.saveBatch(list);
        return Result.success();
    }
