...
import com.example.project.entity.Rotation;
...
public class RotationController {
    ...
    @AutoLog("编辑轮播图")
    @PutMapping
    public Result update(@RequestBody Rotation rotation) {
    ...
    public Result findPage(@RequestParam(defaultValue = "") String name,
        ...
        QueryWrapper<Rotation> queryWrapper = new QueryWrapper<Rotation>().orderByDesc("id");
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Rotation信息表", "UTF-8");
    ...
    */
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Rotation> list = reader.readAll(Rotation.class);

        rotationService.saveBatch(list);
        return Result.success();
    }
